    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-[1400px] flex-col px-5 pb-16 pt-28 sm:px-8 sm:pt-32 lg:grid lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-10 lg:px-12 lg:pb-20 lg:pt-32">
        ...
        >
          <motion.div
            variants={itemVariants}
            className="mb-5 inline-flex items-center gap-3 rounded-full border border-cyan-300/15 bg-cyan-300/[0.04] px-4 py-2"
          >
            <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-cyan-300 shadow-[0_0_12px_rgba(103,232,249,0.75)]" />
          ...
          >
            <div
              aria-hidden="true"
              className="pointer-events-none absolute left-1/2 top-1/2 h-44 w-[72%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-500/[0.08] blur-[70px]"
            />
            ...
            <Image
              ...
              height={828}
              priority
              sizes="(max-width: 640px) 92vw, (max-width: 1024px) 620px, 560px"
              className="relative mx-auto h-auto w-full max-w-[520px] select-none object-contain drop-shadow-[0_0_24px_rgba(49,215,255,0.16)] sm:max-w-[580px] lg:mx-0 lg:max-w-[560px]"
            />
          </motion.div>

          <motion.p
            variants={itemVariants}
            className="mx-auto mt-5 max-w-lg font-[var(--font-poppins)] text-base leading-7 text-slate-300/85 sm:mt-6 sm:text-lg sm:leading-8 lg:mx-0"
          >
            Building immersive websites,
            memorable brands and intelligent
            digital systems for businesses
          ...
          >
            <Link
              href="#work"
              className="cta-button inline-flex min-h-14 items-center justify-center rounded-xl border border-cyan-300/50 bg-cyan-300/[0.07] px-7 py-4 font-[var(--font-poppins)] text-xs font-semibold uppercase tracking-[0.12em] shadow-[0_0_28px_rgba(49,215,255,0.16)] transition active:scale-[0.98] sm:text-sm"
            >
              Enter the Universe
