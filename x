  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#02030b] text-white">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/2 top-24 h-[42rem] w-[42rem] -translate-x-1/2 rounded-full bg-cyan-500/10 blur-[150px]" />

        <div className="absolute -right-48 top-1/3 h-[32rem] w-[32rem] rounded-full bg-violet-600/10 blur-[150px]" />
      ...
      <section className="relative mx-auto flex min-h-screen max-w-[1500px] items-center px-5 pb-24 pt-40 sm:px-8 lg:px-12">
        <div className="grid w-full gap-16 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          <div>
              ...
              <div className="relative">
                ...
                <div className="mt-8 space-y-3">
                  {[
                    ...
                    <div
                      key={item}
                      className="rounded-2xl border border-white/[0.08] bg-white/[0.035] px-5 py-5"
                    >
